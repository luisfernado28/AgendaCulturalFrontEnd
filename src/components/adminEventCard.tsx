...
import { Dates, Event, EventTypeStatus, ModalTypes, Status } from '../redux/types'
...
function AdminEventCard({
    ...
    const typeOfEvent  = type.toString()==='0' ? 'Hibrido': type.toString()==='1' ?'Presencial' : 'Virtual';
                ...
                >
                    ...
                    >
                        <div>
                            ...
                            Fecha:
                            <Text>
                                {startingDate.toLocaleString('default', { month: 'long' }) +'/'+startingDate.getDay() }
                            </Text>
                        </div>
                        <div>
                            Precio:
